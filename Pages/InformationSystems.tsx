    ...
    fintech: {
      ...
      text:
        lang === "he"
          ...
          : "Extensive experience in financial systems, credit processes, regulation, controls, reporting, and integration between core organizational platforms.",
    },
    processAutomation: {
      title: t("isPage.hero.badges.processAutomation"),
      text:
        lang === "he"
          ? "אפיון ויישום אוטומציות חכמות לשיפור תהליכי עבודה, הפחתת עבודה ידנית, הגדלת דיוק תפעולי וייעול מתמשך בארגון."
          : "Design and implementation of smart automation solutions to improve workflows, reduce manual work, increase operational accuracy, and support continuous efficiency.",
    },
  };
              ...
              <div className="md:w-1/2">
                ...
                <div className="mt-10 flex flex-wrap gap-4">
                  <button
                    ...
                    className="bg-indigo-500/10 backdrop-blur-md border border-indigo-500/30 px-4 py-2 rounded-lg text-indigo-200 text-sm font-bold hover:bg-indigo-500/20 hover:border-indigo-400/50 hover:shadow-[0_0_20px_rgba(99,102,241,0.25)] transition-all duration-300"
                  >
        ...
        >
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-3xl md:text-4xl font-extrabold mb-6 tech-font text-white">
                {
